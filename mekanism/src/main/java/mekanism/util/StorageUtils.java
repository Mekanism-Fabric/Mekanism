...
public class StorageUtils {
    ...
    public static void addStoredEnergy(@Nonnull ItemStack stack, @Nonnull List<Component> tooltip, boolean showMissingCap, ILangEntry langEntry) {
        IStrictEnergyHandler capability = Capabilities.STRICT_ENERGY_CAPABILITY.find(stack, null);
        if (capability != null) {
            IStrictEnergyHandler energyHandlerItem = capability;
...
//    }
     ...
     */
//    @Nonnull
//    public static FluidVariant getStoredFluidFromNBT(ItemStack stack) {
...
//    }
    ...
    public static IEnergyContainer getEnergyContainer(ItemStack stack, int container) {
        if (!stack.isEmpty()) {
            IStrictEnergyHandler energyCapability = Capabilities.STRICT_ENERGY_CAPABILITY.find(stack, null);
            if (energyCapability != null) {
                IStrictEnergyHandler energyHandlerItem = energyCapability;
