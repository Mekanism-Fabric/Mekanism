...
public class UnitDisplayUtils {
    //TODO: Maybe at some point improve on the Texts the two getDisplay methods build, and have them have better translation keys with formats
    ...
    public static Text getDisplay(double temp, TemperatureUnit unit, int decimalPlaces, boolean shift, boolean isShort) {
