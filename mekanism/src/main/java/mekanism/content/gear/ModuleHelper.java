...
//
//    @Override
//    public ItemModule createModuleItem(IModuleDataProvider<?> moduleDataProvider, Item.Settings properties) {
...
//            NbtCompound modulesTag = ItemDataUtils.getCompound(container, NBTConstants.MODULES);
...
//    }
//
//    private Set<ModuleData<?>> loadAllTypes(NbtCompound modulesTag) {
...
//        Identifier registryName = Identifier.tryParse(name);
//        return registryName == null ? null : MekanismAPI.moduleRegistry().getValue(registryName);
//    }
//
//    @Nullable
//    private <MODULE extends ICustomModule<MODULE>> Module<MODULE> load(ItemStack container, ModuleData<MODULE> type, NbtCompound modulesTag,
...
//
//    @Nullable
//    private <MODULE extends ICustomModule<MODULE>> Module<MODULE> load(ModuleData<MODULE> type, ItemStack container, NbtCompound modulesTag, String key,
//                                                                                 @Nullable Class<? extends ICustomModule<?>> typeFilter) {
...
//
//    @Override
//    public IHUDElement hudElement(Identifier icon, Text text, HUDColor color) {
