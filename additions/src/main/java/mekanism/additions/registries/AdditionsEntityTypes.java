...
public final class AdditionsEntityTypes {
    ...
    //public static final EntityBabyEnderman BABY_ENDERMAN = ENTITY_TYPES.register("baby_enderman", EntityType.Builder.create(BabyEndermanEntity::new, SpawnGroup.MONSTER).sized(0.6F, 2.9F), EndermanEntity::createEndermanAttributes);
    //public static final EntityBabySkeleton BABY_SKELETON = ENTITY_TYPES.register("baby_skeleton", EntityType.Builder.create(BabySkeletonEntity::new, SpawnGroup.MONSTER).sized(0.6F, 1.99F), AbstractSkeletonEntity::createAbstractSkeletonAttributes);
    //public static final EntityBabyStray BABY_STRAY = ENTITY_TYPES.register("baby_stray", EntityType.Builder.create(BabyStrayEntity::new, SpawnGroup.MONSTER).sized(0.6F, 1.99F), AbstractSkeletonEntity::createAbstractSkeletonAttributes);
