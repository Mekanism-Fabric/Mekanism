...
public final class AdditionsEntityTypes {
    ...
    public static final EntityType<BabyWitherSkeletonEntity> BABY_WITHER_SKELETON = ENTITY_TYPES.register("baby_wither_skeleton", EntityType.Builder.create(BabyWitherSkeletonEntity::new, SpawnGroup.MONSTER).makeFireImmune().setDimensions(0.7F, 2.4F), BabyWitherSkeletonEntity::createAbstractSkeletonAttributes);
