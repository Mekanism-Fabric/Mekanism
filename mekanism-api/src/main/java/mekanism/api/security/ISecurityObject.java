...
public interface ISecurityObject extends IOwnerObject {
     ...
     *
     * @apiNote To retrieve the "effective" security mode of this object {@link ISecurityUtils#getSecurityMode(BlockApiLookup, boolean)} or
     * {@link ISecurityUtils#getEffectiveSecurityMode(ISecurityObject, boolean)} should be used instead.
     * @see ISecurityUtils#getSecurityMode(BlockApiLookup, boolean)
