...
/**
 * Utility class for interacting with Mekanism's security system. Get an instance from {mekanism.api.MekanismAPI#getSecurityUtils()}.
 *
 * @since 10.2.1
 */
...
public interface ISecurityUtils {
     ...
     * @see #canAccess(UUID, BlockApiLookup, boolean)
     * @see #canAccessObject(Player, ISecurityObject)
     * @see #canAccessObject(UUID, ISecurityObject, boolean)
     * @see #canAccessOrDisplayError(Player, BlockApiLookup)
     */
    @Contract("_, null -> true")
    boolean canAccess(Player player, @Nullable BlockApiLookup provider);
     ...
     * @implNote This method assumes that if the security is {@link SecurityMode#TRUSTED} and there is a clientside player, then the player can access the
     * {@link ISecurityObject security object}. This is done because the list of trusted players is not currently synced to all clients.
     * @see #canAccess(Player, BlockApiLookup)
     * @see #canAccess(UUID, BlockApiLookup, boolean)
     * @see #canAccessObject(UUID, ISecurityObject, boolean)
     * @see #canAccessOrDisplayError(Player, BlockApiLookup)
     */
    ...
    boolean canAccess(@Nullable UUID player, @Nullable BlockApiLookup provider, boolean isClient);
     ...
     */
    @Nullable
    UUID getOwnerUUID(BlockApiLookup provider);
     ...
     */
    SecurityMode getSecurityMode(@Nullable BlockApiLookup provider, boolean isClient);
     ...
     * @return Effective security mode.
     *
     * @see #getSecurityMode(BlockApiLookup, boolean)
     */
     ...
     */
    @Contract("_, null -> true")
    default boolean canAccessOrDisplayError(Player player, @Nullable BlockApiLookup provider) {
