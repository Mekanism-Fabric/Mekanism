...
//    private static IForgeRegistry<Slurry> SLURRY_REGISTRY;
    private static RegistryEntry<ModuleData<?>> MODULE_REGISTRY;
    private static RegistryEntry<RobitSkin> ROBIT_SKIN_REGISTRY;
...
//     */
//  @NotNull
//  public static RegistryEntry<ModuleData<?>> moduleRegistry() {
//      if (MODULE_REGISTRY == null) {
//          MODULE_REGISTRY = Registry.REGISTRIES.get(new Identifier(ModuleData.class.getName()));
//      }
