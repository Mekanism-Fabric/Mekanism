...
public interface  ILaserReceptor {
     ...
     */
    void receiveLaserEnergy(@NotNull FloatingLong energy, Direction side);//TODO - 1.18: Remove the side from this as the side is used when getting the capability.
